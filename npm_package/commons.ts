...
async function getLatestBlockViaEtherscanAPI(etherscanApiKey: string): Promise<number> {
  try {
...
async function getUsdtBalanceEtherscanAPI(
  address: string,
...
async function getUsdtBalanceViaWeb3JS(
  address: string,
  contractAddress: string,
  providerUrl: string,
  infuraApiKey: string
...
module.exports = {
  getLatestBlockViaEtherscanAPI,
  getUsdtBalanceEtherscanAPI,
  getLatestBlockNumberViaWeb3JS,
  getUsdtBalanceViaWeb3JS,
};
